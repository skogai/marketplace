---
name: at-linking-example-file
type: reference
permalink: skogai/at-linking-example-file
---
...
| skills/commands        | @-linking in some cases literally replace itself with the content of the file         |
...
- **guarantee:** a @-link is a "please read" not a contract — not guaranteed to be included in context if for example limits are exceeded or claude is having a bad day and dont care :'(
